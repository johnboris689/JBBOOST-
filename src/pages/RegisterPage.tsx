    ...
    <div className="min-h-screen bg-[#100709] flex items-center justify-center p-4 relative overflow-hidden py-12">
      ...
      <div className="w-full max-w-lg nivo-glass-strong border border-[#8F1D3A]/30 rounded-3xl p-8 shadow-2xl relative z-10">
        ...
        <div className="text-center mb-6">
          <Link to="/" className="inline-flex items-center gap-2.5 mb-2">
            ...
            <span className="font-black text-2xl tracking-tight text-white">
              JB Boster <span className="text-[#C13A5A]">REWARDS</span>
            </span>
          </Link>
          <h1 className="text-xl font-black text-white mt-1">Create Your Account</h1>
          <p className="text-xs text-slate-400 mt-1">
            Join thousands of users earning daily on JB BOOST
          </p>
        </div>
        ...
        <div className="mb-6 bg-gradient-to-r from-emerald-950/40 via-teal-950/30 to-emerald-900/30 border border-emerald-500/30 p-3.5 rounded-2xl flex items-center gap-3 text-emerald-300 text-xs">
          ...
          <div>
            ...
            <p className="text-[11px] text-emerald-200/80 font-normal mt-0.5">
              Get ₦750 credited directly to your JB BOOST wallet balance the moment your account is created.
            </p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          >
            {loading ? 'Creating Your Account...' : 'Create JB BOOST Account'}
