...
export const api = {
  ...
  requestSocialOrderRefill: (id: string) => request<any>(`/api/social/orders/${encodeURIComponent(id)}/refill`, { method: 'POST' }),
  getAdminSocialServices: () => request<any[]>('/api/admin/fulfillment/services', {}, true),
  getAdminFulfillmentCatalogue: () => request<any[]>('/api/admin/fulfillment/catalogue', {}, true),
  syncFulfillmentCatalogue: () => request<any>('/api/admin/fulfillment/sync', { method: 'POST' }, true),
  getProviderBalance: () => request<{ balance: number; currency: string }>('/api/admin/fulfillment/balance', {}, true),
  updateAdminFulfillmentService: (id: string, payload: any) => request<any>(`/api/admin/fulfillment/services/${id}`, { method: 'PATCH', body: JSON.stringify(payload) }, true),
  mapFulfillmentService: (payload: any) => request<any>('/api/admin/fulfillment/mappings', { method: 'POST', body: JSON.stringify(payload) }, true),
  getAdminFulfillmentOrders: () => request<any[]>('/api/admin/fulfillment/orders', {}, true),
  syncAdminFulfillmentOrder: (id: string) => request<any>(`/api/admin/fulfillment/orders/${id}/sync`, { method: 'POST' }, true),
