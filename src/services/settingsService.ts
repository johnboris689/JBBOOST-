...
export const DEFAULT_SETTINGS: SystemSettings = {
  ...
  country: "Nigeria",
  scrollingAnnouncement: "Welcome to JB Boster — simple social-media growth services.",
  liveFeedText: "JB Boster social services are available for Facebook, Instagram, TikTok, YouTube, X and Telegram.",
  welcomeMessage: "Welcome to JB Boster",
  dashboardBanner: "Choose a social platform, select a service and place your growth order.",
  noticeBarText: "",
  bankName: "PalmPay",
  accountName: "pwamunadi ishaku",
  accountNumber: "8960723295",
  servicePrice: "6500",
  paymentInstructions: "Buy coins through the secure KoraPay checkout.",
  paymentNotice: "",
  ...
  tikTokLink: "",
  youtubeLink: "",
  supportEmail: "support@jb-boster.com",
  ...
  aboutUs: "Digital financial service platform...",
  ...
  servicePrefix: "SOCIAL_SERVICE",
  serviceLength: "10",
  serviceValidity: "30 Days",
  videoUrl: "",
  videoEnabled: true,
...
export function applyGlobalTheme(settings: SystemSettings) {
  ...
  const brandName = /nevo/i.test(rawBrandName) ? 'JB Boster' : rawBrandName;
  ...
  try {
    ...
    if (res.ok) {
      ...
      if (data.success && data.settings) {
        ...
        if (/nevo/i.test(String(cachedSettings.websiteName || ''))) cachedSettings.websiteName = 'JB Boster';
        if (/nevo/i.test(String(cachedSettings.senderName || ''))) cachedSettings.senderName = 'JB Boster';
