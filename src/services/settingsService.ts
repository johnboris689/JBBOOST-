...
export const DEFAULT_SETTINGS: SystemSettings = {
  ...
  liveFeedText: "Chioma O. just purchased a SOCIAL_SERVICE Service code • Yusuf D. withdrew ₦25,000",
  welcomeMessage: "Welcome",
  dashboardBanner: "Get started with fast manual service activation & seamless transfers",
  noticeBarText: "",
  bankName: "PalmPay",
