...
export const FAQS = [
  { question: 'How do I buy coins?', answer: 'Open Buy Coins, choose an amount of at least ₦520, continue to the real KoraPay checkout, and return after payment. Your balance is credited only after server-side verification or webhook confirmation.' },
  {
  ...
  {
    question: 'How do I place a social order?',
    answer: 'Choose a social platform and service, enter the quantity and target URL, then place the order from your JB Boster balance.'
  },
  {
