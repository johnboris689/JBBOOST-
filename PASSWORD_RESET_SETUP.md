...
6. The JB Boster password hash is updated in the production database. No external authentication service is required.
...
- `RESEND_FROM_EMAIL` — a sender address/domain permitted by Resend, for example `JB Boster <no-reply@your-verified-domain.com>`.
