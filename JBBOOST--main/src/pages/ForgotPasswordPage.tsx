...
export const ForgotPasswordPage: React.FC = () => {
  ...
  const subtitle = step === 'email'
    ...
    : step === 'password'
    ? 'Choose a strong new password for your JB Boster account.'
    : 'Your JB Boster password has been changed successfully.';
      ...
      <div className="w-full max-w-md nivo-glass-strong rounded-[28px] p-7 sm:p-8 relative z-10">
        <div className="text-center mb-7">
          <Link to="/" className="inline-flex items-center gap-2.5 mb-3">
            ...
            <span className="font-black text-2xl tracking-tight text-white">JB Boster <span className="text-[#C13A5A]">CASH</span></span>
          </Link>
